...
import 'schema/field_note_record.dart';
...
export 'schema/field_note_record.dart';
...
/// Functions to query FieldNoteRecords (as a Stream and as a Future).
Future<int> queryFieldNoteRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FieldNoteRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FieldNoteRecord>> queryFieldNoteRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<List<FieldNoteRecord>> queryFieldNoteRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<FieldNoteRecord>> queryFieldNoteRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
