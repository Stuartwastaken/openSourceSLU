    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'global':
          ...
          break;
        case 'fieldNoteDate':
          result.fieldNoteDate = serializers.deserialize(value,
              specifiedType: const FullType(DateTime)) as DateTime?;
          break;
        case 'fieldNoteName':
...
class _$ToDoListRecord extends ToDoListRecord {
  ...
  bool operator ==(Object other) {
    ...
    return other is ToDoListRecord &&
        ...
        user == other.user &&
        global == other.global &&
        fieldNoteDate == other.fieldNoteDate &&
  ...
  String toString() {
    return (newBuiltValueToStringHelper(r'ToDoListRecord')
          ...
          ..add('user', user)
          ..add('global', global)
          ..add('fieldNoteDate', fieldNoteDate)
...
class ToDoListRecordBuilder
  ...
  DateTime? _fieldNoteDate;
  DateTime? get fieldNoteDate => _$this._fieldNoteDate;
  set fieldNoteDate(DateTime? fieldNoteDate) =>
      _$this._fieldNoteDate = fieldNoteDate;
  ...
  ToDoListRecordBuilder get _$this {
    ...
    if ($v != null) {
      ...
      _user = $v.user;
      _global = $v.global;
      _fieldNoteDate = $v.fieldNoteDate;
